...
export declare function getLicencia(): Promise<import("bson").Document>;
export declare function setUltimoTicket(idTicket: number): Promise<import("mongodb").UpdateResult>;
export declare function setVidAndPid(vid: string, pid: string, com: string): Promise<import("mongodb").UpdateResult>;
