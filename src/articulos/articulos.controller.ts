...
export class ArticulosController {
  ...
  getArticulo(@Body() params) {
    return articulosInstance
      .getInfoArticulo(params.idArticulo)
      .then((res) => {
        if (res != null) {
          ...
          return {
            error: true,
            mensaje: "Backend: Error, el articulo es null",
          };
        }
      })
      .catch((err) => {
        ...
        return {
          error: true,
          mensaje: "Backend: Error en articulos/getArticulo catch",
        };
      });
  }
  ...
  setEstadoTarifaEspecial(@Body() params) {
    if (params.nuevoEstado != undefined && params.nuevoEstado != null) {
      ...
      return {
        error: true,
        mensaje: "Backend: Faltan datos en articulos/setEstadoTarifaVIP",
      };
    }
  }
